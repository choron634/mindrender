...
public class HelicopterAgentSeperate : Agent
{
    ...
    */
    ...
    public override void AgentAction(float[] outputs)
    {
        ...
        */
        ...
        AddReward(Mathf.Max((w * 2 * (CurrentGoal + 1) * d + deltaz - Math.Abs(horizontalangle) - CollisionCount / 20), 0));
    ...
    /*public List<float> CollectObservationsAboutYaw()
    {
